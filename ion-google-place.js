    ...
    function ($ionicTemplateLoader, $ionicBackdrop, $ionicPlatform, $q, $timeout, $rootScope, $document) {
      return {
        ...
        link: function (scope, element, attrs, ngModel) {
          ...
          scope.currentLocation = scope.currentLocation == "true";
          ...
          var POPUP_TPL = [
            ...
            '<input class="google-place-search" type="search" ng-model="searchQuery" placeholder="' + (attrs.searchPlaceholder || 'Enter an address..') + '">',
            '</label>',
                ...
                if (query.length > 3) {
                  ...
                  geocoder.geocode(req, function (results, status) {
                    if (status == google.maps.GeocoderStatus.OK) {
                      ...
                      console.error("Failed to return result from geocode query.");
                    }
